            ...
            var _initialiseProps = function() {
              ...
              (this.shouldAttachToBottom = !1), (this.preservedScrollState = 0), (this.loadingSpinnerHeight = 0), (this.generateComputedUtilityFunctions = function(
                ...
                if (
                  ...
                  }), (o.nodeScrollListener = function() {}), (o.getScrollTop = function() {
                  ...
                  var i = document.querySelector(t.scrollContainerSelector);
                  (o.subscribeToScrollListener = function() {
                    i.addEventListener('scroll', e.infiniteHandleScroll);
                  }), (o.unsubscribeFromScrollListener = function() {
                    i.removeEventListener('scroll', e.infiniteHandleScroll);
                  }), (o.nodeScrollListener = function() {}), (o.getScrollTop = function() {
                    return i.scrollTop;
                  }), (o.setScrollTop = function(e) {
                    i.scroll(0, e);
                  ...
                  (o.subscribeToScrollListener = function() {}), (o.unsubscribeFromScrollListener = function() {}), (o.nodeScrollListener =
                    e.infiniteHandleScroll), (o.getScrollTop = function() {
